...
class Hello(object):
    ...
    def index(self):
     ...
     <html>
    <head>
    <h1>0622cdb Final test2第二題<br />
    <br />40223246/40223221<br />
    <br />蔡孟佑/邱立昇<br />

    <a href="drawspur2">協同齒輪嚙合</a>  <br />
